// Country calling codes + ISO2 codes (for flag-icons) used by the phone
// country-code picker. NANP members (Canada, Caribbean, etc.) all share +1.
...
export const COUNTRY_CODES: CountryCode[] = [
  ...
  { name: 'Cocos Islands', iso2: 'cc', dialCode: '61' },
